...
Cloudflare now follows Saved access. This screen stays icon-first: Morgan explains which endpoint choice fits while the UI only shows the recognizable paths.
