...
describe("Morgan secret-source intent", () => {
  ...
  it("requires actual 1Password detection, metadata review, approval, and redacted apply APIs", () => {
    ...
    assert.deepEqual(secretSourceScreen.quickConnect.targets, [
      ...
      "REX_DISCORD_BOT_TOKEN",
      "GRIZZ_DISCORD_BOT_TOKEN",
      "NOVA_DISCORD_BOT_TOKEN",
      "VIPER_DISCORD_BOT_TOKEN",
      "BLAZE_DISCORD_BOT_TOKEN",
      "TAP_DISCORD_BOT_TOKEN",
      "SPARK_DISCORD_BOT_TOKEN",
      "CLEO_DISCORD_BOT_TOKEN",
      "CIPHER_DISCORD_BOT_TOKEN",
      "TESS_DISCORD_BOT_TOKEN",
      "STITCH_DISCORD_BOT_TOKEN",
      "ATLAS_DISCORD_BOT_TOKEN",
      "BOLT_DISCORD_BOT_TOKEN",
      "BLOCK_DISCORD_BOT_TOKEN",
      "VEX_DISCORD_BOT_TOKEN",
      "ANGIE_DISCORD_BOT_TOKEN",
      "GLITCH_DISCORD_BOT_TOKEN",
    ]);
    assert.doesNotMatch(secretSourceScreen.quickConnect.targets.join("\n"), /^DISCORD_BOT_TOKEN$/m);
  });
